...
class MyGUI:
    ...
    #     user_message = self.textBox.get('1.0', tk.END).strip()
    #
    #     # User's message with blue color
    #     self.chatWindow.tag_config("blue", foreground="blue")
    #     self.chatWindow.insert('end', "User: ", "blue")
    #     self.chatWindow.insert('end', user_message, "blue" + "\n")
    #
    #     # self.AIresponse = OpenAI.write_prompt(user_message)
    #     # self.chatWindow.insert('end', "ChatBot: " + self.AIresponse["choices"][0]["text"] + "\n")
    #
    #     self.textBox.delete('1.0', tk.END)
    #     self.chatWindow.configure(state='disabled')
    ...
    def display_message(self):
        ...
        # AI's message with red color
        self.chatWindow.tag_config("red", foreground="red")
        self.chatWindow.insert('end', "ChatBot: ", "red")
        self.chatWindow.insert('end', self.AIresponse["choices"][0]["text"], "red" + "\n")
